...
public class AttributeSelectionPanel extends JPanel {
	...
	/** for serialization */
	private static final long serialVersionUID = -1417460986234605359L;
	...
	class AttributeTableModel extends AbstractTableModel {
		...
		/**
		 * Creates the table model with the given set of instances.
		 *
	...
	/** Set the table and the instances in the table */
